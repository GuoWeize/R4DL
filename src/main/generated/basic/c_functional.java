...
/**
 * Auto-generated Java file: c_functional.java
 *
 * @author Guo Weize
 * @date 2021/11/09 17:09:49
 */
public final class c_functional extends BaseEntity {
    ...
    public SetEntity<c_condition> f_event = (SetEntity<c_condition>) SetEntity.newInstance();
    ...
    public BoolEntity equal(BaseEntity entity) {
        ...
        c_functional that = (c_functional)entity;
        return BoolEntity.and(
            ...
            f_event.equal(that.f_event),
            f_operation.equal(that.f_operation)
        );
    }
    public static c_functional newInstance() {
        return new c_functional();
    }
